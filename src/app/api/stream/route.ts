...
export async function GET() {
  ...
  // Hoisted so the cancel() callback can reach the same cleanup function
  // as the start() closure. Without this, cancel() is a no-op and intervals
  // keep firing (and hitting Finviz) after the client disconnects.
