...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
  ...
  offering:   { label: "OFFERING",   color: "bg-red-500/20     text-red-300     border-red-500/40"     },
  warning:    { label: "WARNING",    color: "bg-orange-500/20  text-orange-300  border-orange-500/40"  },
};
