...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
  ...
  preannounce: { label: "WARN/PRE-ANN",color: "bg-red-500/20     text-red-300     border-red-500/40"     },
  offering:    { label: "OFFERING",    color: "bg-orange-500/20  text-orange-300  border-orange-500/40"  },
};
