...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
  ...
  pre_announcement: { label: "PRE-ANN",      color: "bg-orange-500/20  text-orange-300  border-orange-500/40"  },
  short_seller:     { label: "SHORT REPORT", color: "bg-red-600/20     text-red-400     border-red-600/40"     },
};
