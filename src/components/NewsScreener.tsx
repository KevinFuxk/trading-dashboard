...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
  ...
  credit:     { label: "CREDIT",     color: "bg-red-600/20     text-red-300     border-red-600/40"     },
  shortreport:{ label: "SHORT RPT",  color: "bg-rose-500/20    text-rose-300    border-rose-500/40"    },
};
